...
From the prepared Power Budget, you can see that there is plenty of current to power my whole circuit, which makes sense as it is a simple light sensor with not many parts that draw large amounts of current. This confirms that my design, as long as it is built correctly, should not have any major issues power-wise, but to meet safety requirements, my subsystem will include a 1 Amp fuse to stop any unexpected large current draws, as the 5V power rail will use a little over 1 Amp in the worst case.
