...
A major change that would make sense on the team scale would be to share a power source, rather than each board having its own power supplies and voltage regulators. This decision was made in accordance with the class requirements, allowing each of us to demonstrate proficiency in creating an individual subsystem that could operate independently, while also enhancing the overall application of the entire system.

Overall, I'm satisfied and impressed with the functionality of my board, as I had no major issues after populating my PCB. However, there are still many areas where I think I could improve. I look forward to building on these concepts in EGR 314, where we will undertake a similar project involving the design of a PCB.
